...
import com.userplex.api.core.http.HttpRequestBody
import com.userplex.api.core.http.HttpResponse
import com.userplex.api.errors.UserplexIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw UserplexIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("USERPLEX_LOG")?.lowercase()) {
