...
import com.userplex.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw UserplexInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw UserplexInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }
