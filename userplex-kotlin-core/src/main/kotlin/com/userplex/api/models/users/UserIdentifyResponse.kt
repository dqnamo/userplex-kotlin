...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserIdentifyResponse].
         *
    ...
    /** A builder for [UserIdentifyResponse]. */
    class Builder internal constructor() {

        private var success: JsonField<Boolean>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(userIdentifyResponse: UserIdentifyResponse) = apply {
            success = userIdentifyResponse.success
            additionalProperties = userIdentifyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserIdentifyResponse].
         *
         ...
         */
        fun build(): UserIdentifyResponse =
    ...
    fun validate(): UserIdentifyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserIdentifyResponse &&
    ...
    override fun toString() =
        "UserIdentifyResponse{success=$success, additionalProperties=$additionalProperties}"
}
