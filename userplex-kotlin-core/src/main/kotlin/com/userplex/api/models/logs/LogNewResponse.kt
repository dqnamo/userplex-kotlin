...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogNewResponse].
         *
    ...
    /** A builder for [LogNewResponse]. */
    class Builder internal constructor() {

        private var success: JsonField<Boolean>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(logNewResponse: LogNewResponse) = apply {
            success = logNewResponse.success
            additionalProperties = logNewResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LogNewResponse].
         *
         ...
         */
        fun build(): LogNewResponse =
            LogNewResponse(checkRequired("success", success), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): LogNewResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LogNewResponse &&
    ...
    override fun toString() =
        "LogNewResponse{success=$success, additionalProperties=$additionalProperties}"
}
