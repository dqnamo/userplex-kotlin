...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.userplex.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.userplex.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.userplex.api.** {
    <init>(...);
