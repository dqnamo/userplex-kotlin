...
dependencies {
    testImplementation(project(":userplex-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../userplex-kotlin-core/src/main/resources/META-INF/proguard/userplex-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.userplex.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../userplex-kotlin-core/src/main/resources/META-INF/proguard/userplex-kotlin-core.pro",
